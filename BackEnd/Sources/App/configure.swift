...
public func configure(_ app: Application) async throws {
    ...
    app.migrations.add(CreateBrands())
    app.migrations.add(CreateCategories())
    app.migrations.add(CreateColors())
    app.migrations.add(CreateArticles())
    app.migrations.add(CreateSizes())
    app.migrations.add(CreateProducts())
    app.migrations.add(CreateReceipts())
    app.migrations.add(CreatePayments())
    app.migrations.add(CreatePointOfSales())
    app.migrations.add(CreateClients())
    app.migrations.add(CreateOrders())
    app.migrations.add(CreateSalesLines())
